...
public class User {
     ...
     * 
     * 
     * // Relation avec Message (One-to-Many pour l’envoi et la réception), avec
     * FetchType.LAZY
     * 
     * @OneToMany(mappedBy = "fromUser", cascade = CascadeType.ALL, orphanRemoval =
     * true, fetch = FetchType.LAZY)
     * 
     * @JoinColumn(name = "from_user_id")
     * private List<Message> sentMessages;
     * 
     * @OneToMany(mappedBy = "toUser", cascade = CascadeType.ALL, orphanRemoval =
     * true, fetch = FetchType.LAZY)
     * 
